<template>
  <div class="min-h-screen flex items-center justify-center bg-gradient-to-r from-orange-100 to-yellow-100 py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-6 grid grid-cols-3 gap-3">
          ...
          <div>
            <button @click="loginWithOAuth('kakao')"
              class="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 transition duration-150 ease-in-out">
              <svg class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <path d="M12 3c-5.52 0-10 3.53-10 7.88c0 2.94 1.97 5.52 4.96 6.97l-1.07 3.58c-.14.47.29.89.74.72l4.09-1.75C11.14 20.45 11.57 20.5 12 20.5c5.52 0 10-3.53 10-7.88C22 6.53 17.52 3 12 3z"/>
              </svg>
            </button>
          </div>
        </div>
